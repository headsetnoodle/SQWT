...
// Copyright (c) 2018, The Tosicoin Project
...
const uint64_t DIFFICULTY_TARGET                             = 42; // seconds

const uint32_t CRYPTONOTE_MAX_BLOCK_NUMBER                   = 500000000;
const size_t   CRYPTONOTE_MAX_BLOCK_BLOB_SIZE                = 500000000;
const size_t   CRYPTONOTE_MAX_TX_SIZE                        = 1000000000;
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 6176;
...
const char     CRYPTONOTE_NAME[]                             = "Tosicoin";
...
const char     LATEST_VERSION_URL[]                          = "http://tosicoin.com";
const std::string LICENSE_URL                                = "https://github.com/headsetnoodle/Tosicoin/blob/development/LICENSE";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
    {  0xc5, 0x0c, 0x4c, 0x6c, 0xaf, 0x52, 0x57, 0x42, 0x65, 0xf9, 0x71, 0xa4, 0xb6, 0xc1, 0x43, 0xe4  }
};

const char* const SEED_NODES[] = {
  "206.189.142.142:11897"
